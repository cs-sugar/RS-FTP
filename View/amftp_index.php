...
<?php } ?>
	...
	<form action="" id="submit_change_form" method="POST">
		...
		?>
		<th width="40"><a href="./index.php?pwd=<?php echo $amftp_am_ftp_pwd;?>&orderby=file_type&order=<?php echo $_GET['orderby'] == 'file_type' ? $order : 'asc';?>">类型
		<?php echo $_GET['orderby'] == 'file_type' ? $order_img : '' ?></a></th>
		<th width="365"><a href="./index.php?pwd=<?php echo $amftp_am_ftp_pwd;?>&orderby=dirfilename&order=<?php echo $_GET['orderby'] == 'dirfilename' ? $order : 'asc';?>">文件名
