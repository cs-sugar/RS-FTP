...
class index extends AmysqlController
{
	...
	public $txt_code = array('php', 'js', 'html', 'xml', 'xhtml', 'htm', 'txt', 'css', 'json', 'conf', 'c', 'cc', 'sh', 'h', 'm4', 'in', 'ac', 'guess', 'sub', 'sln', 'am', 'dot', 'sql', 'htaccess', 'ini', 'log', 'tpl');
	public $img_code = array('png', 'jpg', 'jpeg', 'gif', 'bmp', 'webp');
	public $audio_code = array('mp3', 'aac');
	public $video_code = array('mp4', 'dvd', 'vcd');
	...
	function IndexAction()
	{
		...
		// 下载临时目录
		$tmp_download = _ROOT . '/View/tmp_download/';
		if(!mkdir($tmp_download))
		{
			$tmp_download = '/tmp/tmp_download/';
			mkdir($tmp_download);
		}
	...
	function file_edit()
	{
		...
		// 下载临时目录
		$tmp_download = _ROOT . '/View/tmp_file/';
		if(!mkdir($tmp_download))
		{
			$tmp_download = '/tmp/tmp_file/';
			mkdir($tmp_download);
		}
